    ...
    <div className="w-full flex flex-col ">
      ...
      <div className="flex-1">
        ...
        <div className="mb-[20px]">
          <p className="text-[12px] text-[#e4e7e7] leading-[18px]">
        ...
        <div className="mb-[8px]">
          <span className="text-[14px] text-[#e4e7e7] font-medium">
        ...
        {/* 地址输入卡片 */}
        <div
          className="w-[290px] h-[102px] bg-[#1B1C1C] border border-[#171818] rounded-[20px] relative mb-[20px]"
        ...
        {/* 获得奖励说明 */}
        <div className="mb-[20px]">
          <div className="text-[14px] text-[#e4e7e7] font-medium mb-[8px]">
            {t('wallet.rewards_title')}
          </div>
          <div className="text-[12px] text-[#949E9E] leading-[16px] space-y-[4px] pl-[8px]">
        ...
        <div className="flex gap-[12px]">
          ...
          <button
            onClick={handleSkip}
            className="flex-1 h-[48px] bg-transparent border border-[#3D3D3D] rounded-[24px] text-[#e4e7e7] text-[16px] font-medium hover:bg-[rgba(61,61,61,0.1)] transition-colors"
          >
          ...
          <button
            ...
            className="flex-1 h-[48px] bg-[#5671FB] rounded-[24px] text-white text-[16px] font-medium hover:bg-[#4A63E8] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {t('wallet.confirm')}
          </button>
        </div>
